...
class RolePermissionSeeder extends Seeder
{
    public static function getPermissions(): array
    {
        return [
            ...
            ['name' => 'public.cms.settings.view', 'category' => 'CMS / Landing Page', 'sub_category' => 'Media Sosial & SEO', 'description' => 'Melihat media sosial dan SEO landing page'],
            ['name' => 'public.cms.settings.update', 'category' => 'CMS / Landing Page', 'sub_category' => 'Media Sosial & SEO', 'description' => 'Mengubah media sosial dan SEO landing page'],
