...
export default function Contact() {
    const { site, menus, template, flash } = usePage().props;
    ...
    return <SiteLayout title="Hubungi Kami" site={site} menus={menus} template={template}><main className="inner-page"><div className="shell">
