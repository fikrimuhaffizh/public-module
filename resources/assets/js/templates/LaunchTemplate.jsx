...
export default function LaunchTemplate({ data }) {
    ...
    return (
        <>
            <section className="launch-hero" style={heroStyle}>
                <BackgroundBeams />
                ...
                <div className="shell launch-hero-grid">
                    <Reveal className="launch-hero-copy">
                        <Badge className="launch-badge"><Zap size={14} /> Platform kampus terintegrasi</Badge>
            ...
            {landing?.statistics?.length > 0 && (
                <section className="launch-stats">
                    <div className="shell">
            ...
            {landing?.features?.length > 0 && (
                <Section eyebrow="Keunggulan" title="Semua yang dibutuhkan institusi" text="Fitur dirancang untuk mendukung transformasi digital kampus secara menyeluruh.">
            ...
            {landing?.products?.length > 0 && (
                <Section id="modul" tint eyebrow="Ekosistem modul" title="Solusi modular siap pakai">
                    ...
                    <section className="launch-clients">
                        <div className="shell">
                            <Reveal className="section-heading section-heading--center">
                                ...
                                <h2>Institusi yang memakai platform kami</h2>
                            </Reveal>
            ...
            <Section id="berita" eyebrow="Kabar terbaru" title="Informasi dan pengumuman kampus">
                <NewsGrid announcements={data.announcements} />
            </Section>

            <Section eyebrow="FAQ" title="Pertanyaan yang sering diajukan" narrow>
            ...
            {!landing?.cta && (
                <section className="launch-cta launch-cta--fallback">
                    <div className="shell launch-cta-inner">
                        <Reveal>
